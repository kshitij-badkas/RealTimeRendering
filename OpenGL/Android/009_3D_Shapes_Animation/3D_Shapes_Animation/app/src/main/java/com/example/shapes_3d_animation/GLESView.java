...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void initialize(GL10 gl)
    {
        ...
        FloatBuffer pyramidColorsBuffer = byteBuffer.asFloatBuffer();
    ...
    private void uninitialize()
    {
        ...
        //destroy vbo of pyramid color
        if(vbo_color_pyramid[0] != 0)
        {
            GLES32.glDeleteVertexArrays(1, vbo_color_pyramid, 0);
        ...
        {
            GLES32.glDeleteVertexArrays(1, vbo_color_cube, 0);
            vbo_color_cube[0] = 0;
        }  
