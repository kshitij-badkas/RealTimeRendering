...
import android.opengl.GLES20; //OpenGL ES 2.0
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private int numberOfStrippedUniform;
    ...
    if(iShaderCompiledStatus[0] == GLES32.GL_FALSE)
    {
        ...
        if(iInfoLogLength[0] > 0)
        {
            ...
            System.out.println("KAB : Tesselation Control Shader Complilation Log = "+szInfoLog);
            uninitialize();
            System.exit(0);
        }
    }
    ...
    if(iShaderCompiledStatus[0] == GLES32.GL_FALSE)
    {
        ...
        if(iInfoLogLength[0] > 0)
        {
            ...
            System.out.println("KAB : Tesselation Evaluation Shader Complilation Log = "+szInfoLog);
            uninitialize();
            System.exit(0);
        }
    }
        ...
        numberOfSegmentUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_numberOfSegments");
	    numberOfStrippedUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_numberOfStrips");
    ...
    private void display()
    {
        ...
        //Translate
        Matrix.translateM(translationMatrix, 0, 0.0f, 0.0f, -8.0f);
        ...
        GLES32.glUniform1i(numberOfSegmentUniform, uiNumberOfSegments);
        GLES32.glUniform1i(numberOfStrippedUniform, 1);
        ...
        //CHANGE  'minSdkVersion'  to 24 in app/build.gradle file to solve the error at this point.
