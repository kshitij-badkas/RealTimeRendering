...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    {
        System.out.println("KAB : INSIDE onSurfaceCreated.");
        ...
        System.out.println("KAB : BEFORE initialize.");

        initialize(gl);

        System.out.println("KAB : AFTER initialize.");
    ...
    public boolean onDoubleTap(MotionEvent e)
    {
        ...
        {
            isLightEnabled = 1;
            System.out.println("KAB : isLightEnabled : "+isLightEnabled);
        }
