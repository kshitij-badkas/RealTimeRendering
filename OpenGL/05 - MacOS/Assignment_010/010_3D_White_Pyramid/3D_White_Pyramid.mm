// mkdir -p 3D_White_Pyramid.app/Contents/MacOS
// clang++ -Wno-deprecated-declarations -o 3D_White_Pyramid.app/Contents/MacOS/3D_White_Pyramid 3D_White_Pyramid.mm -framework cocoa -framework QuartzCore -framework OpenGL
...
-(void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [window setTitle:@"KAB:Assignment_010_3D_White_Pyramid"];
    [window center];
