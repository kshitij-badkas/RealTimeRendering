// mkdir -p Per_Vertex.app/Contents/MacOS
// clang++ -Wno-deprecated-declarations -o Per_Vertex.app/Contents/MacOS/Per_Vertex Per_Vertex.mm -framework cocoa -framework QuartzCore -framework OpenGL
...
-(void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [window setTitle:@"KAB:Assignment_018_Per_Vertex_Light_Shading"];
    [window center];
