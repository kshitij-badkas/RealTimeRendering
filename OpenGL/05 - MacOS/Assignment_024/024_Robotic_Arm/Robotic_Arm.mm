...
// clang++ -Wno-deprecated-declarations -o Robotic_Arm.app/Contents/MacOS/Robotic_Arm Robotic_Arm.mm -framework cocoa -framework QuartzCore -framework OpenGL
...
-(void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [window setTitle:@"KAB:Assignment_024_Robotic_Arm"];
    [window center];
...
-(void) drawView
{
    ...
    //variables
    GLfloat armColor[] = { 0.5, 0.35, 0.05, 1.0 };    
    ...
    //draw
    glUniform4fv(colorUniform, 1, (GLfloat*)armColor);
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, vbo_sphere_element);
    ...
    //rotationMatrix = rotate(90.0f, 0.0f, 0.0f, 1.0f); //90.0f in FFP
    rotationMatrix = rotate((GLfloat)elbow, 0.0f, 0.0f, 1.0f);
    modelMatrix = translationMatrix * rotationMatrix * translate(1.0f, 0.0f, 0.0f);
    //modelMatrix = popMatrix() * rotationMatrix* translationMatrix;
