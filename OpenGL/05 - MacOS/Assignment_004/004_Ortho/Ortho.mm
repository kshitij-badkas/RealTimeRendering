...
// clang++ -Wno-deprecated-declarations -o Ortho.app/Contents/MacOS/Ortho Ortho.m -framework cocoa -framework QuartzCore -framework OpenGL
...
-(void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [window setTitle:@"KAB:Assignment_004_Orthographic_Triangle"];
    [window center];
...
-(void) reshape
{
    ...
    if (rect.size.width <= rect.size.height)
    {
        orthographicProjectionMatrix = ortho(-100.0f, 
                                            100.0f, 
                                            (-100.0f * (rect.size.height / rect.size.width)), 
                                            (100.0f * (rect.size.height / rect.size.width)), 
                                            -100.0f, 
                                            100.0f);
    }
    else
    {
        orthographicProjectionMatrix = ortho(-100.0f, 
                                            100.0f, 
                                            (-100.0f * (rect.size.width / rect.size.height)), 
                                            (100.0f * (rect.size.width / rect.size.height)), 
                                            -100.0f, 
                                            100.0f);
    }
