// mkdir -p Coloured_Triangle.app/Contents/MacOS
// clang++ -Wno-deprecated-declarations -o Coloured_Triangle.app/Contents/MacOS/Coloured_Triangle Coloured_Triangle.mm -framework cocoa -framework QuartzCore -framework OpenGL
...
-(void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [window setTitle:@"KAB:Assignment_006_Multicoloured_Triangle"];
    [window center];
