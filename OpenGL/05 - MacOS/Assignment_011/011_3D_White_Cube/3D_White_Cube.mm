// mkdir -p 3D_White_Cube.app/Contents/MacOS
// clang++ -Wno-deprecated-declarations -o 3D_White_Cube.app/Contents/MacOS/3D_White_Cube 3D_White_Cube.mm -framework cocoa -framework QuartzCore -framework OpenGL
...
-(void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [window setTitle:@"KAB:Assignment_011_White_Cube"];
    [window center];
