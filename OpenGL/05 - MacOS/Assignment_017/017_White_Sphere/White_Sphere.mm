// mkdir -p White_Sphere.app/Contents/MacOS
// clang++ -Wno-deprecated-declarations -o White_Sphere.app/Contents/MacOS/White_Sphere White_Sphere.mm -framework cocoa -framework QuartzCore -framework OpenGL
...
-(void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [window setTitle:@"KAB:Assignment_017_White_Sphere"];
    [window center];
...
-(void) prepareOpenGL
{
    ...
    //[sphere getSphereVertexData:sphere_vertices sphere_normals:sphere_normals sphere_textures:sphere_textures sphere_elements:sphere_elements];
