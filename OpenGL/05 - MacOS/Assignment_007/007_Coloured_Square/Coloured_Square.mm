// mkdir -p Coloured_Square.app/Contents/MacOS
// clang++ -Wno-deprecated-declarations -o Coloured_Square.app/Contents/MacOS/Coloured_Square Coloured_Square.mm -framework cocoa -framework QuartzCore -framework OpenGL
...
-(void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [window setTitle:@"KAB:Assignment_007_Coloured_Sqaure"];
    [window center];
