...
void CreateWindow(void)
{
    ...
    XStoreName(gpDisplay,gWindow,"PP : Assignment_002_Perspective_Triangle : by Kshitij Badkas");
...
void Initialize(void)
{
	...
	glBindAttribLocation(gShaderProgramObject, KAB_ATTRIBUTE_POSTION, "vPosition");
	...
	glVertexAttribPointer(KAB_ATTRIBUTE_POSTION, 3, GL_FLOAT, GL_FALSE, 0, NULL);
	
	glEnableVertexAttribArray(KAB_ATTRIBUTE_POSTION);
	...
	//We will Cull Back Faces when animation is not required
