...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName,
		TEXT("D3D11: Assignment_014_Tweaked_Smiley : By Kshitij Badkas"),
...
HRESULT Initialize(void)
{
	...
	*/
	...
	//TEXTURE
	hr = loadD3DTexture(L"Smiley.bmp", &gpID3D11ShaderResourceView_Texture); //L - wchar_t LITERAL
	if (FAILED(hr))
	{
		fopen_s(&gpFile, gpszLogFileName, "a+");
...
HRESULT Display(void)
{
	...
	constantBuffer.otherKeyPressed = 0;
	if (pressed_key == 1)
	{
	...
	{
		constantBuffer.otherKeyPressed = 1;
