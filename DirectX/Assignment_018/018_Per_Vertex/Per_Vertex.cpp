...
HRESULT Initialize(void)
{
	...
	const char* vertexShaderSourceCode =
		...
		//--> IMPLICIT CONVERSION IN HLSL WORKS FOR '*' OPERATOR , NOT FOR '+' --- > RECORDING - 24 mins onwards (18/9/21)
		//  
		//"float3 ambient = la * ka;" \ --> does not give error in '*' --> same for diffuse and specular
		//"output.phong_ads_light = ambient + diffuse + specular;" \ --- > gives error if phong_ads_light is float4
